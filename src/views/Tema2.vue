  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.container.justify-content-around.align-items-center
      ...
      .tarjeta.bloque-slider1-tema2.p-4
        ...
        figure
            img(src='@/assets/curso/temas/img-fondo-slider1-tema2.png', alt='Texto que describa la imagen').img-fondo-slider1-tema2
        ...
        SlyderA(tipo="b")
          .row
            ...
            .col-md-6
              figure
                img(data-aos="flip-right")(src='@/assets/curso/temas/img-diagnostico-tema2.png', alt='Texto que describa la imagen').img-slider-tema2
                //figcaption Leyenda de la imagen

          .row
            .col-md-6.mb-4.mb-md-0
              h4 Ejecución
              p La ejecución de un plan de manejo se divide en cuatro fases. Primero, en la delimitación, se establecen y documentan las problemáticas en la gestión sostenible de los suelos, esto se realiza con la ayuda de la comunidad y se revisa la disponibilidad de recursos económicos para una posible intervención.

            .col-md-6
              figure
                img(data-aos="flip-right")(src='@/assets/curso/temas/img-ejecucion-tema2.png', alt='Texto que describa la imagen').img-slider-tema2
                //figcaption Leyenda de la imagen

          .row
            .col-md-6.mb-4.mb-md-0
              h4 Prácticas a realizar
              p Si los parámetros anteriores se cumplen, se entra en una segunda fase, la de diagnóstico, aquí se dejan por escrito las prácticas no sostenibles del uso del suelo, sirviendo de insumo para iniciar la tercera fase o fase de planificación. En esta, se parte del diagnóstico tanto de las prácticas no sostenibles como del contexto sociocultural.

            .col-md-6
              figure
                img(data-aos="flip-right")(src='@/assets/curso/temas/img-practicas a-realizar-tema2.png', alt='Texto que describa la imagen').img-slider-tema2
                //figcaption Leyenda de la imagen

          .row
            .col-md-6.mb-4.mb-md-0
              h4 Plan de Intervención
              p Posteriormente, se diseña un plan de intervención para la gestión sostenible del suelo, en el cual se incluye un cronograma y el presupuesto necesario para su ejecución, trazando unas metas claras para el final de la intervención. Es importante incluir a la comunidad en este proceso.

            .col-md-6
              figure
                img(data-aos="flip-right")(src='@/assets/curso/temas/img-plan-de-intervencion-tema2.png', alt='Texto que describa la imagen').img-slider-tema2
                //figcaption Leyenda de la imagen

          .row
            .col-md-6.mb-4.mb-md-0
              h4 Implementación
              p Una vez ajustados los parámetros y contando con un documento final que recoja todas las apreciaciones, se pasa a una última fase, la de implementación y seguimiento. Esta fase consiste en la definición de un cronograma de ejecución y de roles dentro del plan de manejo, tanto para el personal técnico como para la comunidad.

            .col-md-6
              figure
                img(data-aos="flip-right")(src='@/assets/curso/temas/img-implementacion-tema2.png', alt='Texto que describa la imagen').img-slider-tema2
                //figcaption Leyenda de la imagen
